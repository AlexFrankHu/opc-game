...
function MercenaryUpStepPageBase.onFunction( eventName,container )
	...
	elseif eventName == "onSynthesisBook" then
		MercenaryUpStepPageBase.onSynthesisBook( container )
	...
	elseif eventName == "" then
		MercenaryUpStepPageBase.onCompoundStone( container )
	end
end
...
function MercenaryUpStepPageBase.onSynthesisBook( container )
