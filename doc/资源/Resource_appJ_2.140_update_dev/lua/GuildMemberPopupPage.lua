...
function GuildMemberPopBase:onPromote(container)
	if MyAllianceInfo.myInfo == nil or memberInfo.id == nil then 
...
function GuildMemberPopBase:onKickOut(container)
	if MyAllianceInfo.myInfo == nil or memberInfo == nil or memberInfo.id == nil or memberInfo.postion == nil then 
		MessageBoxPage:Msg_Box('@GuildDataError')
		return
	end
