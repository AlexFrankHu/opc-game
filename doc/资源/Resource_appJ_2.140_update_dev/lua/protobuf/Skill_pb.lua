...
SKILLINFO_ROLEID_FIELD.number = 5
SKILLINFO_ROLEID_FIELD.index = 0
SKILLINFO_ROLEID_FIELD.label = 1
...
SKILLINFO_ITEMID_FIELD.number = 2
...
SKILLINFO_SKILLLEVEL_FIELD.number = 3
...
SKILLINFO_STATUS_FIELD.number = 4
