...
local CumulativeLoginDataHelper = require("CumulativeLoginDataHelper")
...
function CumulativeLoginContent.onRefreshItemView(container)
	...
	if rewardInfo~=nil then
        ...
        if index > CumulativeLoginPage.DataHelper:getVariableByKey("CumulativeLoginDays") then
            NodeHelper:setMenuItemEnabled(container,"mRewardBtn",false)
        end
