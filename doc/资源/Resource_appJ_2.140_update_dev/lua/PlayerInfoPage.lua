...
-----------------------------------------------
--PlayerInfoPageBaseÒ³ÃæÖÐµÄÊÂ¼þ´¦Àí
----------------------------------------------
function PlayerInfoPageBase:onEnter(container)
	...
	if  platformName~= nil and (platformName == "PP" or platformName == "KY") then -- PPÆ½Ì¨ÐèÒªµ÷ÓÃÆäÓÃ»§ÖÐÐÄ 
...
local function onLogOffConfirm(flag)
	if flag then	
		--ÖØµÇÂ½ reenter£¬×¢ÒâÔÚmain.luaÀïÓÐ¸ötheOnLogOutConfirmº¯Êý£¬Óë±¾º¯ÊýÓ¦¸Ã±£³ÖÒ»ÖÂ
		CCLuaLog("ReEnter")
